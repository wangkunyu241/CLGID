...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.TRAINING.START = 0
        self._C.TRAINING.NUM_TASK = 4
        self._C.TRAINING.NAME_TASK = ['rain100H','rain1400','rain100L','rain1200_medium']
        self._C.TRAINING.TEST_TASK = ['SPA','RainDS_test','RealRain-1k-H-test','RealRain-1k-L-test']
        self._C.TRAINING.ED_PATH = '/gdata1/wangky/rain/pt/'
        self._C.TRAINING.TEST_PATH = '/gdata1/wangky/rain/real/'
        self._C.TRAINING.LAMBDA_D = 1
