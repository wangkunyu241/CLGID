...
We have released the code for our TNNLS 2025 paper "Towards Better De-raining Generalization via Rainy Characteristics Memorization and Replay". Our code uses MPRNet as the exemplified de-raining network for illustrating our method.
